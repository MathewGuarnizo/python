...
# Verificar si Kevin está en el diccionario antes de intentar eliminarlo
if 'Kevin' in calificaciones:
    del calificaciones['Kevin']

# Iterar a través del diccionario actualizado
for i, j in calificaciones.items():
    print(i, j)